...
The first assay was developed for two panels targeting either 8 (NOMADS8) or 16 (NOMADS16) genes associated with drug resistance, diagnostic escape, vaccine target and genetic diversity <sup>1</sup>. This assay prioritised generation of long reads (e.g. those spanning entire target genes). The [protocol](https://www.protocols.io/view/cost-effective-targeted-nanopore-sequencing-of-p-f-yxmvm25m6g3p/v2) takes 3 days and involves a significant number of processes including a 17 hour selective Whole Genome Amplification (sWGA) step. 

<sup>1</sup> de Cesare, M. et al. Flexible and cost-effective genomic surveillance of *P. falciparum* malaria with targeted nanopore sequencing. Nat Commun 15, 1413 (2024). [Publication](https://pubmed.ncbi.nlm.nih.gov/38360754/)
...
NOMADS MVP assay validation is published as a [pre-print](https://www.biorxiv.org/content/10.1101/2025.07.23.666274v1), while the protocol is available in [English](https://www.protocols.io/view/nomads-mvp-rapid-genomic-surveillance-of-malaria-w-kxygxy284l8j/v1) and [French](https://www.protocols.io/view/surveillance-g-nomique-du-paludisme-par-la-m-thod-q26g75b5qlwz/v1).

***

# Software
A key component of NOMADS is making software to support implementation of the NOMADS assay. We strive to produce tools that are easy to implement and focus on enabling implementers to independently run and analyse their own data. All software is available on github - click headers to visit the individual repositories.


### [resources](https://github.com/nomads-community/resources)
...
### [bioinformatics](https://github.com/nomads-community/bioinformatics)
